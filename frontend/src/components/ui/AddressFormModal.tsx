...
export default function AddressFormModal({
    ...
    const validate = (): boolean => {
        ...
        if (form.country.trim().toLowerCase() !== "australia")
            e.country = "Only Australian addresses are allowed";
        ...
        try {
            const payload = {
                ...
                latitude: form.latitude
                    ? parseFloat(parseFloat(form.latitude).toFixed(6))
                    : null,
                longitude: form.longitude
                    ? parseFloat(parseFloat(form.longitude).toFixed(6))
                    : null,
            };
            if (initial?.id) {
                ...
                <div className="overflow-y-auto px-5 py-5 space-y-4 flex-1">
                    ...
                    <div>
                        ...
                        {autofilled && (
                            <div className="flex items-center gap-1.5 mt-1.5 text-xs text-green-600 animate-pulse">
                                ...
                                Fields filled automatically — review and confirm
                                below.
                            </div>
                        )}
                    </div>
                    ...
                    {form.latitude && form.longitude && (
                        <p className="text-xs text-gray-400 flex items-center gap-1">
                            ...
                            GPS verified: {parseFloat(form.latitude).toFixed(5)}
