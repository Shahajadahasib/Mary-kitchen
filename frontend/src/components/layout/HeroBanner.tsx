...
export default function HeroBanner() {
    return (
        <section className="relative bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 text-white overflow-hidden">
            ...
            />
            <div className="container-xl px-4 py-10 sm:py-12 md:py-14 relative">
                <div className="max-w-2xl">
                    {/* Badge */}
                    <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 w-fit mb-4 sm:mb-5 text-xs sm:text-sm font-medium">
                        <Truck className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-brand-300" />
                    ...
                    <div className="flex flex-wrap gap-3 sm:gap-4">
                        ...
                        <Link
                            href="/shop/products?category=fish-seafood"
                            className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl transition-colors border border-white/20 text-sm sm:text-base"
                        >
                            Fresh Fish Today
                        </Link>
                    </div>
