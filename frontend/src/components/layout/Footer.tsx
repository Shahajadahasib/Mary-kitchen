...
export default function Footer() {
    ...
    const instagramHref = store?.instagram
        ? safeHref(store.instagram)
        : undefined;
    ...
    return (
        <footer className="bg-gray-900 text-gray-300 pt-10 pb-6 mt-auto">
            <div className="container-xl px-4">
                ...
                {/* Bottom bar */}
                <div className="border-t border-gray-800 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-sm text-gray-500 text-center sm:text-left">
                    <p>
