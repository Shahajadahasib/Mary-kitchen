...
/**
 * Chrome for the grocery storefront. Split out of `app/shop/layout.tsx` so that
 * the layout itself can be a server component and own the segment's metadata —
 * the same split the restaurant uses with `RestaurantShell`.
 */
