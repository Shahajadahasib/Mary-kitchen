...
export default function NewProductPage() {
    ...
    const handleCreateCategory = async (e: React.FormEvent) => {
        ...
        setCatLoading(true);
        try {
            const { data } = await api.post("/products/admin/categories/", {
                ...catForm,
                is_active: true,
            });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (imageFile && product?.id) {
                ...
                try {
                    await api.post(
                        `/products/admin/products/${product.id}/images/`,
                        fd,
                        {
                    ...
                    toast.error(
                        "Product created, but image upload failed. You can add it from the edit page.",
                    );
                }
            }
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div data-field="compare_price">
                            ...
                            <input
                                ...
                                onChange={update("compare_price")}
                                className={inputClass("compare_price")}
                                placeholder="0.00"
                            />
