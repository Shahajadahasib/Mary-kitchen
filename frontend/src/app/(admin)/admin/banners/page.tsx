    ...
    const saveMutation = useMutation({
        mutationFn: (payload: FormState) => {
            ...
            if (payload.starts_at)
                fd.append("starts_at", toUTCISO(payload.starts_at));
            if (payload.ends_at)
                fd.append("ends_at", toUTCISO(payload.ends_at));
                            ...
                            {isLoading ? (
                                ...
                                banners.map((banner) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3">
                                            <span
                                                className={`badge ${LOCATION_COLORS[banner.location]}`}
                                            >
                                                {LOCATIONS.find(
                                                    (l) =>
                                                        l.value ===
                                        ...
                                        <td className="px-4 py-3">
                                            ...
                                            >
                                                <span
                                                    className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform ${banner.is_active ? "translate-x-4.5" : "translate-x-0.5"}`}
                                                />
                                            </button>
                                        </td>
                                        <td className="px-4 py-3">
