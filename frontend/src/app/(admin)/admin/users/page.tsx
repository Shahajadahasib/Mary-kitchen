...
export default function AdminUsersPage() {
    ...
    const promoteMutation = useMutation({
        mutationFn: (userId: string) =>
            api.patch(`/users/admin/users/${userId}/`, { is_staff: true }),
        onSuccess: () => {
    ...
    const demoteMutation = useMutation({
        mutationFn: (userId: string) =>
            api.patch(`/users/admin/users/${userId}/`, { is_staff: false }),
        onSuccess: () => {
            qc.invalidateQueries({ queryKey: ["admin-users"] });
                            ...
                            {isLoading ? (
                                ...
                                data?.results?.map((user: AdminUser) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 text-gray-600 max-w-[120px] sm:max-w-none truncate">
                                            {user.email}
                                        </td>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
                        ...
                        <p className="text-xs text-primary-700 bg-primary-50 rounded-lg px-3 py-2 mb-5">
                            This user will be able to manage products, orders,
                            and other users in the admin panel.
                        </p>
