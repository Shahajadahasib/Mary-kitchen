import { CheckCircle, DollarSign, MapPin, Package, Truck } from "lucide-react";
import Link from "next/link";

const zones = [
    {
        name: "Darwin CBD & Surrounds",
        radius: "0–10 km",
        fee: "$30.00",
        time: "Same day / 4–8 hrs",
    },
    {
        name: "Palmerston & Suburbs",
        radius: "10–18 km",
        fee: "$40.00",
        time: "Same day / 8–12 hrs",
    },
    {
        name: "Outer Darwin Area",
        radius: "18–25 km",
        fee: "$50.00",
        time: "Next day",
    },
            ...
            <div className="container-xl py-14 space-y-12">
                ...
                <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                        <MapPin className="w-6 h-6 text-primary-700" /> Delivery
                        Zones
                    </h2>
                            ...
                            <thead className="bg-primary-50">
                                <tr>
                                    {[
                                        ...
                                        <th
                                            key={h}
                                            className="px-5 py-3 text-left font-semibold text-primary-700"
                                        >
                                            {h}
                                        </th>
                                    ))}
                    ...
                    <p className="text-sm text-gray-500 mt-3 flex items-center gap-1">
                        <MapPin className="w-4 h-4" /> We currently deliver
                        within a 25 km radius of our Winnellie store.
                    </p>
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-7">
                    ...
                    <ul className="space-y-2 text-sm text-amber-800">
                        ...
                        <li>
                            • Orders over <strong>$100</strong> receive{" "}
                            <strong>free delivery</strong> within all zones.
                        </li>
                        <li>
                            • Delivery fees are non-refundable once your order
                            has been dispatched.
                        </li>
                    </ul>
                </div>
