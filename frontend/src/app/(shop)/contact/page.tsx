...
const FALLBACK_CARDS: ContactCard[] = [
    ...
    },
    {
        icon: Mail,
        label: "Email",
        value: "hello@marykitchen.com.au",
        href: "mailto:hello@marykitchen.com.au",
    },
];
...
export default function ContactPage() {
    ...
    const hoursRows: HoursRow[] =
        store?.opening_hours && !is247
            ? store.opening_hours.split("\n").map((line) => {
                  const colonIdx = line.indexOf(":");
                  if (colonIdx === -1)
                      return { day: line, time: "", closed: false };
    ...
    const cards: ContactCard[] = store
        ? ([
              store.address
                  ? { icon: MapPin, label: "Our Store", value: addressValue }
                  : null,
              store.phone
                  ? {
                        icon: Phone,
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="container-xl px-4 py-10 sm:py-14">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    {href ? (
                                        <a
                                            href={href}
                                            className="text-sm text-primary-700 hover:underline font-medium whitespace-pre-line"
                                        >
                                            {value}
                                        </a>
                                    ) : (
