...
export default function ProductDetailPage() {
    ...
    const displayCompare = currentVariant
        ...
        : product.compare_at_price != null &&
            String(product.compare_at_price).length > 0
                ...
                <div>
                    ...
                    <div className="mb-4">
                        {product.is_in_stock ? (
                            ...
                            <span className="text-sm text-orange-500 font-medium">
                                ⚠ Out of Stock –{" "}
                                {product.allow_out_of_stock_orders
                                    ? "You can still order"
                    ...
                    <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 mb-4">
                        ...
                        <button
                            ...
                            className="flex-1 btn-primary flex items-center justify-center gap-2 min-w-[140px]"
                        >
                    ...
                    {Object.keys(product.attributes || {}).length > 0 && (
                        <div className="mt-4 pt-4 border-t border-gray-100">
                            ...
                            <dl className="grid grid-cols-2 gap-2">
                                {product.attribute_definitions?.map(
                                    (def: any) =>
